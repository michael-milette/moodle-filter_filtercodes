...
$string['enableteamcards'] = 'Enable {teamcards} tag';
$string['enableteamcards_desc'] = 'If enabled, the {teamcards} tag displays cards for users with roles selected in Site administration > Appearance > Course > Course contacts. If disabled, the tag renders nothing and user cards are not generated.';
